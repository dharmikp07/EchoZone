...
<form action="view-post.php?action=add-commment&amp;post_id=<?php echo $postId ?>" method="post"
    ...
    <div>
        ...
        <textarea id="comment-text" name="comment-text" rows="8"
            cols="70"> <?php echo htmlEscape($commentData['text']) ?> </textarea>
    </div>
    <div>
